...
### 5. 🪤 Análise das Demais Alternativas *(opcional — use quando agregar valor)*
Para cada distrator relevante, explique brevemente por que está incorreto, evidenciando os "pegadinhas" mais comuns da banca.

### 6. 📌 Regra de Ouro / Memorização
...
### 7. 🔁 Conexão com o Edital / Recorrência do Tema *(se aplicável)*
